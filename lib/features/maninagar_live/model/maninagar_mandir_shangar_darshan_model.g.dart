...
_$ManinagarMandirShangarDarshanModelFromJson(Map<String, dynamic> json) =>
    _ManinagarMandirShangarDarshanModel(
...
Map<String, dynamic> _$ManinagarMandirShangarDarshanModelToJson(
  _ManinagarMandirShangarDarshanModel instance,
) => <String, dynamic>{
