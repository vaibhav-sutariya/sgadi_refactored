...
part of 'maninagar_mandir_shangar_darshan_model.dart';
...
/// @nodoc
mixin _$ManinagarMandirShangarDarshanModel {
...
/// Create a copy of ManinagarMandirShangarDarshanModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ManinagarMandirShangarDarshanModelCopyWith<ManinagarMandirShangarDarshanModel> get copyWith => _$ManinagarMandirShangarDarshanModelCopyWithImpl<ManinagarMandirShangarDarshanModel>(this as ManinagarMandirShangarDarshanModel, _$identity);

  /// Serializes this ManinagarMandirShangarDarshanModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ManinagarMandirShangarDarshanModel&&(identical(other.isError, isError) || other.isError == isError)&&(identical(other.message, message) || other.message == message)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.data, data));
}
...
@override
String toString() {
  return 'ManinagarMandirShangarDarshanModel(isError: $isError, message: $message, status: $status, data: $data)';
}
...
/// @nodoc
abstract mixin class $ManinagarMandirShangarDarshanModelCopyWith<$Res>  {
  factory $ManinagarMandirShangarDarshanModelCopyWith(ManinagarMandirShangarDarshanModel value, $Res Function(ManinagarMandirShangarDarshanModel) _then) = _$ManinagarMandirShangarDarshanModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ManinagarMandirShangarDarshanModelCopyWithImpl<$Res>
    implements $ManinagarMandirShangarDarshanModelCopyWith<$Res> {
  _$ManinagarMandirShangarDarshanModelCopyWithImpl(this._self, this._then);

  final ManinagarMandirShangarDarshanModel _self;
  final $Res Function(ManinagarMandirShangarDarshanModel) _then;
...
/// Adds pattern-matching-related methods to [ManinagarMandirShangarDarshanModel].
extension ManinagarMandirShangarDarshanModelPatterns on ManinagarMandirShangarDarshanModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ManinagarMandirShangarDarshanModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ManinagarMandirShangarDarshanModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ManinagarMandirShangarDarshanModel value)  $default,){
final _that = this;
switch (_that) {
case _ManinagarMandirShangarDarshanModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ManinagarMandirShangarDarshanModel value)?  $default,){
final _that = this;
switch (_that) {
case _ManinagarMandirShangarDarshanModel() when $default != null:
return $default(_that);case _:
...
class _ManinagarMandirShangarDarshanModel implements ManinagarMandirShangarDarshanModel {
  const _ManinagarMandirShangarDarshanModel({@JsonKey(name: "isError") this.isError, @JsonKey(name: "message") this.message, @JsonKey(name: "status") this.status, @JsonKey(name: "data") final  List<Datum>? data}): _data = data;
  factory _ManinagarMandirShangarDarshanModel.fromJson(Map<String, dynamic> json) => _$ManinagarMandirShangarDarshanModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$ManinagarMandirShangarDarshanModelCopyWith<_ManinagarMandirShangarDarshanModel> get copyWith => __$ManinagarMandirShangarDarshanModelCopyWithImpl<_ManinagarMandirShangarDarshanModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ManinagarMandirShangarDarshanModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ManinagarMandirShangarDarshanModel&&(identical(other.isError, isError) || other.isError == isError)&&(identical(other.message, message) || other.message == message)&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other._data, _data));
}
...
/// @nodoc
abstract mixin class _$ManinagarMandirShangarDarshanModelCopyWith<$Res> implements $ManinagarMandirShangarDarshanModelCopyWith<$Res> {
  factory _$ManinagarMandirShangarDarshanModelCopyWith(_ManinagarMandirShangarDarshanModel value, $Res Function(_ManinagarMandirShangarDarshanModel) _then) = __$ManinagarMandirShangarDarshanModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "isError") bool? isError,@JsonKey(name: "message") String? message,@JsonKey(name: "status") bool? status,@JsonKey(name: "data") List<Datum>? data
});
...
/// @nodoc
class __$ManinagarMandirShangarDarshanModelCopyWithImpl<$Res>
    implements _$ManinagarMandirShangarDarshanModelCopyWith<$Res> {
  __$ManinagarMandirShangarDarshanModelCopyWithImpl(this._self, this._then);

  final _ManinagarMandirShangarDarshanModel _self;
  final $Res Function(_ManinagarMandirShangarDarshanModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? isError = freezed,Object? message = freezed,Object? status = freezed,Object? data = freezed,}) {
  return _then(_ManinagarMandirShangarDarshanModel(
isError: freezed == isError ? _self.isError : isError // ignore: cast_nullable_to_non_nullable
as bool?,message: freezed == message ? _self.message : message // ignore: cast_nullable_to_non_nullable
as String?,status: freezed == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
...
@JsonKey(name: "stream") String? get stream;@JsonKey(name: "stream_web") String? get streamWeb;@JsonKey(name: "is_stream") String? get isStream;@JsonKey(name: "img_slug") String? get imgSlug;@JsonKey(name: "title") String? get title;@JsonKey(name: "desc") String? get desc;@JsonKey(name: "images") List<dynamic>? get images;
...
@useResult
$Res call({
@JsonKey(name: "stream") String? stream,@JsonKey(name: "stream_web") String? streamWeb,@JsonKey(name: "is_stream") String? isStream,@JsonKey(name: "img_slug") String? imgSlug,@JsonKey(name: "title") String? title,@JsonKey(name: "desc") String? desc,@JsonKey(name: "images") List<dynamic>? images
});
...
class _LiveJson implements LiveJson {
  const _LiveJson({@JsonKey(name: "stream") this.stream, @JsonKey(name: "stream_web") this.streamWeb, @JsonKey(name: "is_stream") this.isStream, @JsonKey(name: "img_slug") this.imgSlug, @JsonKey(name: "title") this.title, @JsonKey(name: "desc") this.desc, @JsonKey(name: "images") final  List<dynamic>? images}): _images = images;
