...
//
//     final maninagarShangarDarshanModel = maninagarShangarDarshanModelFromJson(jsonString);

import 'dart:convert';

import 'package:freezed_annotation/freezed_annotation.dart';

part 'maninagar_shangar_darshan_model.freezed.dart';
part 'maninagar_shangar_darshan_model.g.dart';

ManinagarShangarDarshanModel maninagarShangarDarshanModelFromJson(String str) =>
    ManinagarShangarDarshanModel.fromJson(json.decode(str));

String maninagarShangarDarshanModelToJson(ManinagarShangarDarshanModel data) =>
    json.encode(data.toJson());

@freezed
abstract class ManinagarShangarDarshanModel
    with _$ManinagarShangarDarshanModel {
  const factory ManinagarShangarDarshanModel({
  ...
  factory ManinagarShangarDarshanModel.fromJson(Map<String, dynamic> json) =>
      _$ManinagarShangarDarshanModelFromJson(json);
}
...
abstract class LiveJson with _$LiveJson {
  const factory LiveJson({
    ...
    @JsonKey(name: "images") List<List<String>>? images,
  }) = _LiveJson;
